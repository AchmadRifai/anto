...
public abstract class Add extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Masukan Telepon :");
    ...
    private void kodeKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_kodeKeyReleased
        if (!"".equals(kode.getText())) try {
            Db d = new Db();
            var p = d.prep("select kode from suplier where kode=?");
    ...
    private void refresh() {
        s.setEnabled(Color.BLACK == kode.getForeground() && !"".equals(kode.getText()) && !"".equals(nama.getText()) &&
                !"".equals(almt.getText()) && !"".equals(telp.getText()));
    }

    private void simpan() {
        try {
            Db d = new Db();
            var p = d.prep("insert into suplier values(?,?,?,?,?)");
            p.setString(1, kode.getText());
